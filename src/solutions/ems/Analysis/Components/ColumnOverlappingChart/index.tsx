...
export const ColumnOverlappingChart: React.FC<Props> = ({
  className,
  ...
  xLabels = true,
  yAxis = true,
  yAxisColors = [`${colors.primary.subtle.DEFAULT}`, `${colors.primary.focus}`],
  yAxisMaxValue,
  yAxisValues = [],
  ...props
}) => {
  ...
  return <ReactApexChart type='bar' height={height} options={options as ApexOptions} series={series} />;
};
