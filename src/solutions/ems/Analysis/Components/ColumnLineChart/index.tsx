...
export const ColumnLineChart: React.FC<Props> = ({
  className,
  ...
  yAxis = true,
  yAxisColors = [
    `${colors.primary.subtle.DEFAULT}`,
    `${colors.success.subtle.DEFAULT}`,
    `${colors.primary.subtle.active}`,
    `${colors.success.subtle.active}`,
  ],
  yAxisMaxValue,
  yAxisValues = [],
  ...props
  ...
  const options = {
    ...
    stroke: {
      show: showStroke,
      width: [0, 4, 0, 4],
      colors: [colors.blue['500'], colors.success.subtle.DEFAULT, colors.blue['800'], colors.success.subtle.active],
    },
    colors: yAxisColors,
    dataLabels: {
      enabled: false,
    ...
    yaxis: [
      {
        show: yAxis,
        seriesName: t('ems.kWhLastMonth.label', 'kWh last month', 'Month Node Consumption label'),
        labels: {
          style: {
            colors: chartColor,
            fontFamily: chartFontFamily,
      ...
      },
      {
        show: yAxis,
        opposite: true,
        seriesName: t('ems.cO2eLastMonth.label', 'cO2e last month', 'Month Node Consumption label'),
        labels: {
          style: {
            colors: chartColor,
            fontFamily: chartFontFamily,
