...
export const modules: Modules = [
...

  {
    ...
    title: 'solutions.analytics.label',
  ...
  },
  {
    ...
    title: 'solutions.reporting.label',
    icon: <File05LineIcon />,
  ...
  },
  {
    ...
    title: 'solutions.massConfiguration.label',
