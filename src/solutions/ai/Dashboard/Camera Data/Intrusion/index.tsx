...
// Mock data for intrusion events
const intrusionData = Array.from({ length: 12 }, (_, i) => ({
  id: `${i + 1}`,
...
const IntrusionCard: React.FC<IntrusionCardProps> = ({ image, date, time, cameraName, detectionType }) => {
  return (
